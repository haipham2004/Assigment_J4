...
<body>
<div class="container">
    <form action="/UpdateGioHang?id=${mtam.id}" method="post">
        <div class="mt-3">
            <lable>Mã</lable>
        ...
        <div class="mt-3">
            ...
            <input type="date" class="form-control" name="ngayThanhToan" value="${mtam.ngayThanhToan}">
        </div>
        <div class="mt-3">
            <lable>Tên người nhận</lable>
