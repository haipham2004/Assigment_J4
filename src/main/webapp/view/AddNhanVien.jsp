...
<div class="container">
    <form action="/AddNhanVien" method="post">
        ...
        <div class="mt-3">
            ...
            <input type="text" class="form-control" name="gioiTinh" value="${mtam.gioiTinh}">
        </div>
        <div class="mt-3">
        ...
        <div class="mt-3">
            <lable>Địa chỉ</lable>
            <input type="text" class="form-control" name="diaChi" value="${mtam.soDienThoai}">
        </div>
        <div class="mt-3">
        ...
        <div class="mt-3">
            ...
            <input type="text" class="form-control" name="cuaHang.id" value="${mtam.cuaHang.ten}">
        </div>
        <div class="mt-3">
            <lable>Chức vụ</lable>
            <input type="text" class="form-control" name="chucVu.id" value="${mtam.chucVu.ten}">
        </div>
