...
<body>
<div class="container">
    <form action="/UpdateNhanVien?id=${mtam.id}" method="post">
        <div class="mt-3">
            <lable>Mã</lable>
        ...
        <div class="mt-3">
            ...
            <input type="text" class="form-control" name="cuaHang.id" value="${mtam.cuaHang.id}">
        </div>
        <div class="mt-3">
            <lable>Chức vụ</lable>
            <input type="text" class="form-control" name="chucVu.id" value="${mtam.chucVu.id}">
        </div>
